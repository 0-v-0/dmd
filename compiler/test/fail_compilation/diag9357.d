...
fail_compilation/diag9357.d(18): Error: cannot implicitly convert expression `1048575.0L` of type `real` to `int`
fail_compilation/diag9357.d(19): Error: cannot implicitly convert expression `1048576.0L` of type `real` to `int`
---
*/
void main()
{
